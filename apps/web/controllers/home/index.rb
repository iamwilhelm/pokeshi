    ...
    def call(params)
      @sushi = {
        ...
        name: {
          ...
          alternates: [
            ["hamachi", "Name for Farmed Buri, or Young Buri ~ 1 ft / 1 year in Osaka"],
            ["tsubasa", "Name for fry ~4 in and 6 months in Osaka"],
        ...
        preparation: {
          ...
          videos: [
            { source: "Catalina Ops", url: "https://www.youtube.com/embed/Yf3hrp3dmIo", },
            { source: "Chef Jay Huang", url: "https://www.youtube.com/embed/oPsPqAS4nXw", },
          ],
        },
        ...
        references: [
          ...
          ["The edible ocean", "http://theedibleocean.blogspot.com/2012/04/yellow-tales.html"],
          ["Wikipedia", "https://en.wikipedia.org/wiki/List_of_sushi_and_sashimi_ingredients"],
          ["Fishbase", "http://www.fishbase.org/summary/Seriola-dumerili.html"],
        ],
      }
