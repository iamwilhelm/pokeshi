...
module Web
  class Application < Hanami::Application
    configure do
      ...
      #
      security.content_security_policy "default-src 'none'; script-src 'self' https://ajax.googleapis.com; connect-src 'self'; img-src 'self'; style-src 'self' 'unsafe-inline'; font-src 'self'; frame-src https://www.youtube.com"
